import { SpringValues, animated, useSpring, config as springConfig } from '@react-spring/web';
...
function DraggaBleComponentActive(
  ...
  const spring = useSpring({
    width: isHovering ? hoveredTargetCoordinates.width : elementRef.current?.clientWidth,
    height: isHovering ? hoveredTargetCoordinates.height : elementRef.current?.clientHeight,
